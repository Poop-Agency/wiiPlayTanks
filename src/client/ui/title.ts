...
function coopSection(): HTMLElement {
  ...
  note.textContent =
    'Deux à quatre joueurs sur la même campagne. Les règles se choisissent dans ' +
    'le salon, une fois entré. Qui arrive après le départ regarde, jusqu\'à ce ' +
    'qu\'un joueur le fasse entrer.';
  section.append(note);
